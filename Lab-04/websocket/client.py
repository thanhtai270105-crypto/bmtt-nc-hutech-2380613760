import tornado.ioloop  # Sửa: ilooop -> ioloop
import tornado.websocket


class WebSocketClient:
    def __init__(self, io_loop):  # Sửa: definit -> __init__
...
def main():
    io_loop = tornado.ioloop.IOLoop.current()  # Sửa: iloop -> ioloop
